...
class OpenCodeApiKeyStore(
    ...
    private fun loadKey(): String? {
        return try {
            ...
            LOG.warning("Failed to load OpenCode API key: ${exception.message}")
            null
        }
    }
    ...
    companion object {
        private const val SERVICE_NAME = "OpenCode API Key"
        private const val USER_NAME = "opencode-api-key"
